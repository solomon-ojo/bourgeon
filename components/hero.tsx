          ...
          <div className="max-w-3xl mx-auto">
              <div className="text-center pb-12 md:pb-16">
                <h1 className="font-inter-tight text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-zinc-500 via-zinc-900 to-zinc-900 pb-4">
                  Build <em className="italic relative inline-flex justify-center items-center text-zinc-900"> custom
                  ...
                  </em> software for your start-up idea
                </h1>
                <p className="text-lg text-zinc-500 mb-8">
                  Go from idea to product ready in <span className='font-bold'>only one month</span> and start raising funds for your business.
                </p>
